...
public class Main {
    ...
    public static void main() {
        ...
        // >>> EXCEÇÃO (GABARITO do Exercício 1 de tratamento de exceções): mesmo padrão
        // do saque lá em cima -- aplicarRendimento() agora lança quando o percentual não
        // é positivo, e é este try/catch/finally que evita que o programa pare de rodar.
        try {

            // Percentual negativo: o throw acontece ANTES do super.depositar(), então
            // o saldo de ciNatan não muda nem uma linha entra no extrato.
            ciNatan.aplicarRendimento(-0.10);

            System.out.println(">> Rendimento de -10% aplicado.");

        } catch (IllegalArgumentException e) {

            // getMessage() devolve o texto que o throw carregou em ContaInvestimento.java.
            System.out.println(">> Rendimento de -10% RECUSADO (" + e.getMessage() + ")");

        } finally {

            // finally roda sempre -- com exceção ou sem ela.
            System.out.println(">> Fim da tentativa de aplicar rendimento.");
