...
// deste projeto. Por isso Main consegue usar Cachorro sem import. Em produção, todo projeto
// real declara um pacote nomeado (ex: "package com.empresa.projeto;"); pacote default é
// aceitável só em exemplo/exercício de aula.

// Cachorro é uma subclasse de Animal: herda nome, raca, dono, latitude, longitude
// e os métodos (getters/setters, rastrear(), emitirSom(), toString()) sem reescrevê-los
public class Cachorro extends Animal {
    // corpo vazio: Cachorro não adiciona nem sobrescreve nada, só reaproveita o de Animal
}
